...
<div class="container" style="margin-top:100px">
    <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
        ...
        <!-- Nếu có danh mục cha -->
        @if($parentCategory)
            <a href="{{ route('fr.product', ['menu_id' => $parentCategory->id]) }}" class="stext-109 cl8 hov-cl1 trans-04">
                {{ $parentCategory->name }}
                <i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
            </a>
        @endif
			...
			<div class="bor10 m-t-50 p-t-43 p-b-40">
				...
				<div class="tab01">
					...
					<ul class="nav nav-tabs" role="tablist">
						...
						<li class="nav-item p-b-10">
							<a class="nav-link" data-toggle="tab" href="#reviews" role="tab">Đánh giá ( {{$reviewCount}} )</a>
						</li>
					</ul>
								...
								<div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
                                    ...
                                    <div class="flex-w flex-t p-b-68">
                                        <div class="wrap-pic-s size-109 bor0 of-hidden m-r-18 m-t-6">
                                            <img src="{{ asset('template/images/download.png') }}" alt="AVATAR">
                                        </div>
                                        <div class="size-207">
                                            ...
                                            @if($review->admin_reply)
                                                <div class="admin-reply mt-4">
                                                    ...
                                                    <p class="stext-102 cl6" style="margin-left: 20px; font-style: italic; color: #007bff;">
                                                        {{ $review->admin_reply }}
                                                    </p>
                                                </div>
                                            @endif
										...
										<form class="w-full" method="POST">
											...
											<div class="flex-w flex-m p-t-50 p-b-23">
												<span class="wrap-rating fs-18 cl11 pointer">
													...
													<i class="item-rating pointer zmdi zmdi-star-outline"></i>
													<input class="dis-none" type="hidden" name="rating" value="">
